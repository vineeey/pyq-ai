/**
 * Minimal Lucide Icons Fallback
 * Provides basic icon rendering using SVG
 */
(function() {
    'use strict';
    ...
    const icons = {
        ...
        'settings': '<circle cx="12" cy="12" r="3"></circle><path d="M12 1v6m0 6v6m5.2-13.8 5.2-3-3 5.2m-8.4 8.4-3 5.2 5.2-3m0-8.4-5.2-3 3 5.2m8.4 8.4 3 5.2-5.2-3"></path>',
    ...
    window.lucide = {
        createIcons: function(options) {
            ...
            elements.forEach(el => {
                ...
                const iconPath = icons[iconName] || icons['alert-circle'];
                
                // Get size from class or default
                const classes = el.className;
                let size = 24;
                if (classes.includes('w-4') || classes.includes('h-4')) size = 16;
                if (classes.includes('w-5') || classes.includes('h-5')) size = 20;
                if (classes.includes('w-6') || classes.includes('h-6')) size = 24;
                if (classes.includes('w-8') || classes.includes('h-8')) size = 32;
                if (classes.includes('w-12') || classes.includes('h-12')) size = 48;
                ...
                // Copy classes - setAttribute works better than className for SVG
